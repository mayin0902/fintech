...
- Twinkle 的核心框架、GRPO/DPO loss、vLLM sampler、分布式调度与文档属于 ModelScope Contributors；
...
| 完整 GRPO cookbook | [`cookbook/rl/grpo.py`](https://github.com/mayin0902/twinkle/blob/main/cookbook/rl/grpo.py) |
| LoRA DPO cookbook | [`cookbook/rl/dpo_lora.py`](https://github.com/mayin0902/twinkle/blob/main/cookbook/rl/dpo_lora.py) |
